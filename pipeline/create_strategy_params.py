...
CORE_CONSTRAINTS = [
    ...
    ["max_turnover",               "0.10",  "FALSE", "Two-way turnover cap Σ|w−w_prev| vs latest live holdings (incubation book); disabled by default, enable to throttle rebalance churn"],
